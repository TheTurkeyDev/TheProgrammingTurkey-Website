            ...
            <div>
                ...
                >
                    ...
                    {auth.permissions.includes('streamtimer.dashboard') && (
                        <div className="row m-0">
                            <Link className="col" to="/streamtimer">
                                Stream Timer Dashboard
                            </Link>
                        </div>
                    )}
                    {auth.permissions.includes('chancecubes.rewardbuilder') && (
                        <div className="row m-0">
                            <Link className="col" to="/chancecubes/rewardbuilder">
                                Chance Cubes Reward Builder
                            </Link>
                        </div>
                    )}
                    {auth.permissions.includes('user.accountconnections') && (
                        <div className="row m-0">
                            <Link className="col" to="/user/connectedaccounts">
                                Connected Accounts
                            </Link>
                        </div>
                    )}
                    {
                        ...
                        <div className="row m-0">
                            <Link className="col" to="/user/youtubesubget">
                                YouTube Sub Count
                            </Link>
                        </div>
                    }
                    {
                        ...
                        <div className="row m-0">
                            <Link className="col" to="/twitchgames">
                                Twitch Games
                            </Link>
                        </div>
                    }
                    {auth.permissions.includes('twitchclipfilter') && (
                        <div className="row m-0">
                            <Link className="col" to="/twitchclipfilterer/clips">
                                Twitch Clip Filterer
                            </Link>
                        </div>
                    )}
                    ...
                    {adminShow && (
                        <>
                            ...
                            <hr />
                            {
                                ...
                                <div className="row m-0">
                                    <Link className="col" to="/chancecubes/managecontentcreators">
                                        Manage Chance Cubes Content Creators
                                    </Link>
                                </div>
                            }
                            {
                                ...
                                <div className="row m-0">
                                    <Link className="col" to="/projects/statusedit">
                                        Edit Project Status'
                                    </Link>
                                </div>
                            }
                            {
                                ...
                                <div className="row m-0">
                                    <Link className="col" to="/admin/usermanage">
                                        Manage Users
                                    </Link>
                                </div>
                            }
                            {
                                ...
                                <div className="row m-0">
                                    <Link className="col" to="/admin/permissionmanage">
                                        Manage Permission
                                    </Link>
                                </div>
                            }
                            {auth.permissions.includes('admin.manageprocesses') &&
                                <div className="row m-0">
                                    <Link className="col" to="/admin/processmanage">
                                        Manage Processes
                                    </Link>
                                </div>
                            }
