...
class SlimeRancherIntegration extends Component {
    constructor(props) {
        super(props);
    }
        ...
        return (
            <PageWrapper>
                <div className="text-center mr-5 ml-5">
                    <h1 className="mt-2">Slime Rancher Twitch Twitch Integration</h1>
                    ...
                    <ul className="list-group" >
                        <li className="list-group-item bg-primary pt-0 pb-0">Spawning objects</li>
                        <li className="list-group-item bg-primary pt-0 pb-0">Downgrading plots</li>
                        <li className="list-group-item bg-primary pt-0 pb-0">Inventory bomb</li>
                        <li className="list-group-item bg-primary pt-0 pb-0">Player stats edit</li>
                        <li className="list-group-item bg-primary pt-0 pb-0">Move/ Pushing the player</li>
                        <li className="list-group-item bg-primary pt-0 pb-0">Adjusting player's money</li>
                        <li className="list-group-item bg-primary pt-0 pb-0">Shoot the players gun</li>
...
export default SlimeRancherIntegration;