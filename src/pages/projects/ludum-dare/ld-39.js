            ...
            <PageWrapper>
                <div className="text-center mr-5 ml-5">
                    ...
                    <p>
                        ...
                        After not competing in the last Ludum Dare do to my college schedule, I spent a lot of time, probably more than any other Ludum Dare, to create this game for LD 39.
                        Welcome to power Synergy! A turn based game where you try to outwit you opponent (A Computer for the moment) by collecting and assigning power to robot units in
                        order to destroy the opposing army. More infomarion is included in the ingame help screen.
                    ...
                    <div>
                        ...
                        |
                        <a className="ml-1" href="" onClick={() => window.open('https://github.com/Turkey2349/LudumDare39')}>
                            Source Code
                        </a>
                    </div>
                    <div className="mt-3">
