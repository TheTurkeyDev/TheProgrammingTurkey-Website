...
export function Dependency(props) {
    ...
    const deleteInstance = () => {
        overlay.pushCurrentOverlay(<ConfirmationOverlay text={`Are you sure you want to delete this dependency?`} options={
            [
    ...
    return (
        <div className="m-2 container pb-3" style={{ border: `1px solid ${props.color}` }}>
            <div className="row ml-2 mt-2">
                ...
                <input className="col" style={{ maxWidth: "250px" }} type="text" value={props.value} onChange={(e) => { props.changeValue(e.target.value) }} />
                <div className="ml-auto col-auto" onClick={() => deleteInstance()}>
