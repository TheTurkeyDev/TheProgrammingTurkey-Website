...
import { ChanceCubesAddRewardTypeOverlay } from '../../../overlays/chance-cubes-add-reward-type-overlay';
        ...
        <div className="m-2 container" style={{ border: `1px solid ${props.color}` }}>
            ...
            <div className={`row m-2 ${collapsed ? "hidden" : ""}`}>
                ...
                <div className="toggle-switch">
                    ...
                    <span className="toggle-slider round" onClick={(e) => setIsGiantCC()}></span>
                </div>
            </div>
            <div className={`row m-2 ${collapsed ? "hidden" : ""}`}>
