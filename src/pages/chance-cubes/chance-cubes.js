        ...
        <PageWrapper>
            <div className="text-center mr-5 ml-5">
                ...
                <div>
                    <a
                        className="mr-1"
                        href="https://www.curseforge.com/minecraft/mc-mods/chance-cubes"
                    >
                    ...
                    <a
                        className="ml-1"
                        href="https://github.com/TheTurkeyDev/ChanceCubes"
                    >
                        Source Code
                    </a>
                    |
                ...
                <div className="mt-2">
                    <a
                        className="ml-1"
                        href="https://www.youtube.com/watch?v=zxzvBvMB0qQ"
                    >
                ...
                <div className="mt-2">
                    <a
                        className="ml-1"
                        href="https://www.youtube.com/watch?v=CMjavS2m2Tw"
                    >
                        Math Reward
                    </a>
                </div>
                <div className="mt-2">
                    <a
                        className="ml-1"
                        href="https://www.youtube.com/watch?v=VdiEjBlgbTs"
                    >
                ...
                <div className="mt-2">
                    <a
                        className="ml-1"
                        href="https://clips.twitch.tv/BenevolentGoldenClipsmomChocolateRain"
                    >
                ...
                <div className="mt-2">
                    <a
                        className="ml-1"
                        href="https://clips.twitch.tv/PopularBoredEelFunRun"
                    >
                        Tic-Tac-Toe Reward
                    </a>
                </div>
