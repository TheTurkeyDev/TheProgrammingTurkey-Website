...
export const ChanceCubesStats = () => {
    ...
    const versionLineGraphRef = createRef();
    const versionPieGraphRef = createRef();
    const mcVersionUsageGraphRef = createRef();
    const mcVersionPieGraphRef = createRef();
    const mcVersionLineGraphRef = createRef();
    const runTotalsGraphRef = createRef();
