            ...
            <div className="fluid-container pl-3">
                ...
                <div className="row m-0 mt-3 mb-2">
                    <label
                        ...
                        style={{ fontSize: '22px', maxWidth: '100px' }}
                    >
                        URL:
                    </label>
                    <input
                        ...
                        value={
                            showURL
                                ? `${getAppsSiteBase()}/twitch/rps?token=${token}`
                                : ''
                        }
                        style={{ width: '800px' }}
                    />
