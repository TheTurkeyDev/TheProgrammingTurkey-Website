        ...
        <PageWrapper>
            <div className='text-center mr-5 ml-5'>
                ...
                <div>
                    <a
                        className='mr-1'
                        href='http://files.theprogrammingturkey.com/index.html?path=ludm_dare/turkeys_plant_emporium_72_hr.jar'
                    >
                        Download
                    </a>
                    |
                    <a
                        ...
                        onClick={() =>
                            window.open(
                                'https://ldjam.com/events/ludum-dare/46/turkeys-plant-emporium'
                            )
                        }
                    >
                        Ludum Dare Page
                    ...
                    <a
                        ...
                        onClick={() =>
                            window.open(
                                'https://github.com/TheTurkeyDev/LudumDare46'
                            )
                        }
                    >
                        Source Code
                ...
                <div className='mt-3'>
                    ...
                    <iframe
                        width='560'
                        height='315'
                        src='https://www.youtube.com/embed/S_9nnH3hBDA'
                        frameBorder='0'
