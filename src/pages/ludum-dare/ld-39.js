        ...
        <PageWrapper>
            <div className="text-center mr-5 ml-5">
                ...
                <div>
                    <a
                        className="mr-1"
                        href="http://files.theprogrammingturkey.com/index.html?path=ludm_dare/Power_Synergy_48hr_Patch_2.jar"
                    >
                        Download
                    </a>
                    |
                    <a
                        ...
                        onClick={() =>
                            window.open(
                                'https://ldjam.com/events/ludum-dare/39/power-synergy'
                            )
                        }
                    >
                        Ludum Dare Page
                    ...
                    <a
                        ...
                        onClick={() =>
                            window.open(
                                'https://github.com/TheTurkeyDev/LudumDare39'
                            )
                        }
                    >
                        Source Code
