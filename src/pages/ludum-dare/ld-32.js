        ...
        <PageWrapper>
            <div className="text-center mr-5 ml-5">
                ...
                <div>
                    <a
                        className="mr-1"
                        href="https://www.dropbox.com/s/frl19eo272tc7f8/LD32.jar?dl=0"
                    >
                        Download
                    </a>
                    |
                    <a
                        ...
                        onClick={() =>
                            window.open(
                                'http://ludumdare.com/compo/ludum-dare-32/?action=preview&uid=24562'
                            )
                        }
                    >
                        Ludum Dare Page
                    ...
                    |
                    <a className="ml-1" href="" onClick={() => window.open('https://github.com/TheTurkeyDev/LudumDare32')}>
                        Source Code
                    </a>
                </div>
            </div>
